...
object TDMValidator {
    ...
    private fun parsePositive(
        ...
        return when {
            ...
            value == null -> {
                errors[key] = "$fieldLabel must be a number."
                null
            }
    ...
    fun validatePre(
        ...
        val infusionDurationHr = parsePositive(
            infusionDurationHrText,
            "Infusion duration",
            MIN_INFUSION_DURATION_HR,
            MAX_INFUSION_DURATION_HR,
            errors,
            "infusionDurationHr"
        )

        val preLevelConc = parsePositive(
            preLevelText,
            "Pre-dose level",
            MIN_LEVEL_CONC,
            MAX_LEVEL_CONC,
    ...
    fun validatePost(
        ...
        val samplingTimeHr = parsePositive(
            samplingTimeHrText,
            "Sampling time",
            MIN_TIME_HR,
            MAX_TIME_HR,
        ...
        val postLevelConc = parsePositive(
            postLevelText,
            "Post-dose level",
            MIN_LEVEL_CONC,
            MAX_LEVEL_CONC,
        ...
        if (
            samplingTimeHr != null &&
            intervalHr != null &&
            samplingTimeHr >= intervalHr
        ) {
            errors["samplingTimeHr"] =
                "Sampling time must be less than the dosing interval."
        }
    ...
    fun validatePrePost(
        ...
        val infusionToPostGapHr = parsePositive(
            infusionToPostGapHrText,
            "Infusion-to-post gap",
            MIN_TIME_HR,
            MAX_TIME_HR,
            errors,
            "infusionToPostGapHr"
        ...
        val preToPostGapHr = parsePositive(
            preToPostGapHrText,
            "Pre-to-post gap",
            MIN_TIME_HR,
            MAX_TIME_HR,
        ...
        if (
            preToPostGapHr != null &&
            intervalHr != null &&
            preToPostGapHr >= intervalHr
        ) {
            errors["preToPostGapHr"] =
        ...
        if (
            preLevelConc != null &&
            postLevelConc != null &&
            postLevelConc <= preLevelConc
        ) {
            errors["postLevelConc"] =
                "Post-dose level should normally be higher than pre-dose level."
        }
